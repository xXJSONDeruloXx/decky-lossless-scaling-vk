    ...
    def _generate_script_content(self, config: ConfigurationData) -> str:
        ...
        if config.get("per_game_profiles", False):
            lines.extend([
                ...
                "",
                "    # Auto-create profile if it doesn't exist (fire-and-forget background task)",
                ...
                "        # Trigger profile creation via Python script in background",
                "        python3 -c \"",
                ...
                "        service.update_game_profile('$profile_name', config)",
                "except Exception as e:",
                "    pass  # Silent fail for auto-creation",
                "\" &",
                "    fi",
                "else",
